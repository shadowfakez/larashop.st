        ...
        <div class="min-h-screen w-64 absolute sm:relative bg-gray-900 shadow md:h-full flex-col justify-between hidden sm:flex">
            <div class="px-8">
                <ul class="mt-12">
                    ...
                    <li class="flex w-full justify-between cursor-pointer items-center mb-6 hover:text-gray-100 @adminLayoutActiveRoute('admin.products*')">
                    ...
                    <li class="flex w-full justify-between cursor-pointer items-center mb-6 hover:text-gray-100 @adminLayoutActiveRoute('dashboard')">
