...
@section('admin-content')
    <div class="py-5">
        <div class='overflow-x-auto w-full'>
            <a href="{{ route('categories.create') }}" type="button" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-6">Add New Category</a>
            <table
                ...
                @foreach($categories as $category)
                    ...
                    <tr class="border-b">
                        ...
                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            <a type="button" href="{{ route('categories.show', $category->alias) }}"
                        ...
                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            <a type="button" href="{{ route('categories.edit', $category->alias) }}"
                        ...
                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            <form action="{{ route('categories.destroy', $category->alias) }}" method="POST" class=" d-grid gap-2">
                                @csrf
                                @method('DELETE')
