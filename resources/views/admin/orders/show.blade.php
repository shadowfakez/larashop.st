            ...
            <a href="">
                <div class="rounded overflow-hidden p-4 m-4 group block mx-auto rounded-lg bg-white ring-1 ring-slate-900/5 space-y-3 border-indigo-400">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <table
                            ...
                            @foreach($order->products as $product)
                                <tr class="border-b">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <a href=""
                                           class="hover:text-rose-600">{{ $product->price }} {{ $order->currency->symbol }}</a>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <a href=""
                                           class="hover:text-rose-600">{{ $product->price * $product->pivot->count }} {{ $order->currency->symbol }}</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
                        ...
                        <div class="text-right text-xl mb-4"><b>Total price: </b>{{ $order->getSumInCurrentCurrency() }}</div>
