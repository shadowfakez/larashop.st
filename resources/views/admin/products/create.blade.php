    ...
    <div class="py-5">
        <div class='overflow-x-auto w-full'>
            <form action="{{ route('admin.products.store') }}" method="POST"
                ...
                <div class="mb-6">
                    <select name="property_id[]" multiple class="items-center w-full text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
